...
@Table(name="test_data", alias="a", columns={
        ...
        @JoinTable(type= JoinTable.Type.LEFT_JOIN, entity=User.class, attrName="testUser", alias="u10",
                on="u10.user_code = a.test_user_code", columns={
                @Column(name="user_code", label="用户编码", isPK=true),
                @Column(name="user_name", label="用户名称", isQuery=false),
        }),
        @JoinTable(type= JoinTable.Type.LEFT_JOIN, entity=Office.class, attrName="testOffice", alias="u11",
...
public class PoiVo extends DataEntity<PoiVo>{
